        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PiecesPerPackage = table.Column<int>(type: "int", nullable: false),
                    Volume = table.Column<int>(type: "int", nullable: true),
                    Density = table.Column<int>(type: "int", nullable: false),
                    ProductionTimeDays = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NovaPoshtaBranch = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    NovaPoshtaTrackingNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LiqPayOrderId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LiqPayPaymentId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LiqPayStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
